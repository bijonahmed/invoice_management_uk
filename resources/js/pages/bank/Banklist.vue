        ...
        <div class="page-wrapper">
            ...
            <div class="page-content">
                <div class="alert-primary" role="alert">
                    <div class="row">
                        <div class="col-md-10">Bank List </div>
                    </div>
                </div><br>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="bank_name" placeholder="Search Bank Name"
                ...
                <div class="col-md-12">
                    <div class="table-responsive w-100">
                        ...
                        <button class="btn btn-primary w-100 edit-mode" @click="editMMode" style="display: none;">Edit
                            Mode</button>
                        <button class="btn btn-primary w-100 create-invoice" @click="createInvoice"
                            style="display: none;">Create Invoice</button>
...
export default {
    ...
    methods: {
        ...
        deleteRow() {
            let id = $(".id").val();
            axios.post(`/api/token/removeToken?id=${id}`).then((res) => {
                $('.btn-close').click();
                this.datatable.draw();
                Swal.fire({
                    position: 'top-end',
        ...
        addNew() {
            this.$router.push('/bank/add-new-bank');
        },
