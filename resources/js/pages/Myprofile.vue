							...
							<div id="kt_content_container" class="container-xxl">
										...
										<div class="d-flex flex-wrap flex-sm-nowrap mb-3">
											<div class="me-7 mb-4">
												<div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
													<img src="/backend/assets/media/avatars/150-26.jpg" alt="image" />
								...
								<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
									<div class="card-header cursor-pointer">
										...
										<router-link to="/edit-profile" class="btn btn-primary align-self-center">Edit Profile</router-link>
									</div>
									<div class="card-body p-9">
										...
										<div class="row mb-7">
											...
											<div class="col-lg-8 fv-row">
												<span class="fw-bold text-gray-800 fs-6">{{ company }}</span>
											</div>
										</div>
										<div class="row mb-7">
											...
											<div class="col-lg-8 d-flex align-items-center">
												<span class="fw-bolder fs-6 text-gray-800 me-2">{{ contact }}</span>
   ...
   export default {
    ...
    created() {
        if (authUser !== null) {
			...
			this.company  = authUser.company;
			this.contact  = authUser.contact;
