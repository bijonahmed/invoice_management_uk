    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
            <div class="alert-primary" role="alert">
                <div class="row">
                    <div class="col-md-10">Customer List</div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control customer" placeholder="Customer Name">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="input-group mb-3">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" class="customer_id" v-model="customer_id" />
                        </div>
    ...
    methods: {
        defaultLoadingData() {
            this.datatable = $('#datatable').DataTable({
                ...
                'searching': false,
                'ajax': {
                    'url': `/api/category/getCustomerData`,
                    'data': function (data) {
        ...
        addNew() {
            this.$router.push('/customer/add-new-customer');
        }
