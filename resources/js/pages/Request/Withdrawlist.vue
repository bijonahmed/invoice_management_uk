        ...
        <div class="page-wrapper">
            ...
            <div class="page-content">
                <div class="alert-primary" role="alert">
                    <div class="row">
                        <div class="col-md-10">Withdrawal List</div>
        ...
        methods: {
            defaultLoadingData() {
                this.datatable = $('#datatable').DataTable({
                    ...
                    'searching': false,
                    'ajax': {
                        'url': `/api/withdrawal/getWithdrawalList`,
                        'data': function (data) {
            ...
            cancelRow() {
                let id = $(".id").val();
                axios.post(`/api/withdrawal/cancel?id=${id}`).then((res) => {
                    $('.btn-close').click();
                    this.datatable.draw();
                    Swal.fire({
                        position: 'top-end',
            ...
            apporvedRow() {
                let id = $(".id").val();
                axios.post(`/api/withdrawal/approved?id=${id}`).then((res) => {
                    $('.btn-close').click();
                    this.datatable.draw();
                    Swal.fire({
                        position: 'top-end',
