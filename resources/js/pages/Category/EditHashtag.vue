<template>
                            ...
                            <div class="card-body">
                                <form @submit.prevent="saveData()" id="formrest" class="forms-sample" enctype="multipart/form-data">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="hidden" class="form-control" v-model="cdata.has_tag_id" id="has_tag_id" placeholder="Name">
    ...
    export default {
        ...
        methods: {
            ...
            findRowId() {
                this.axios
                    .get(`/api/category/editHashTagId/${this.$route.params.id}`)
                    .then((response) => {
                        this.cdata.has_tag_id = response.data.data.has_tag_id;
                        this.cdata.has_tag_name = response.data.data.has_tag_name;
