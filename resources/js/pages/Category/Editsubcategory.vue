<template>
    <div class="main-wrapper">
        <div class="page-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-md-10">Edit Sub Category</div>
                    <div class="col-md-2">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form @submit.prevent="saveData()" id="formrest" class="forms-sample"
                                    ...
                                    <div class="row mb-3">
                                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Sub
                                            Category
                                            Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control sub_category_name"
                                                v-model="cdata.sub_category_name" id="sub_category_name"
                                                name="sub_category_name" placeholder="Name" @keyup="checkName">
    ...
    export default {
        ...
        methods: {
            ...
            findRowId() {
                this.axios
                    .get(`/api/category/editSubCategoryId/${this.$route.params.id}`)
                    .then((response) => {
                        this.cdata.sub_cate_id = response.data.data.sub_cate_id;
                        this.cdata.category_id = response.data.data.category_id;
                        this.cdata.sub_category_name = response.data.data.sub_category_name;
