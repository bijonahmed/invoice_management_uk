        ...
        <div class="page-wrapper">
            ...
            <div class="page-content">
                <div class="alert-primary" role="alert">
                    <div class="row">
                        <div class="col-md-10">Hash Tag List</div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control has_tag_name" placeholder="Name">
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <center style="color: red; font-size: 15px; font-weight: bold;">Do you want to delete this Hash Tag?</center>
                                <input type="hidden" class="has_tag_id" v-model="has_tag_id" />
                            </div>
        ...
        methods: {
            defaultLoadingData() {
                this.datatable = $('#datatable').DataTable({
                    ...
                    'searching': false,
                    'ajax': {
                        'url': `/api/category/getHasTagData`,
                        'data': function (data) {
                            let info = $('#datatable').DataTable().page.info();
                            data.page = info.page + 1;
                            var status = $('.status').val();
                            var has_tag_name = $('.has_tag_name').val();
    
                            //Append Data
                            data.status = status;
                            data.has_tag_name = has_tag_name;
            ...
            deleteRow() {
                ...
                let id = $(".has_tag_id").val();
                axios.post(`/api/category/removeHashTag?id=${id}`).then((res) => {
                    $('.btn-close').click();
                    this.datatable.draw();
                    Swal.fire({
                        position: 'top-end',
            ...
            addNew() {
                this.$router.push('/category/add-new-hash-tag');
            }
