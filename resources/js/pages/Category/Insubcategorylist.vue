    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
            <div class="alert-primary" role="alert">
                <div class="row">
                    <div class="col-md-10">In Sub Category List</div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control category" placeholder="Account Name">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="input-group mb-3">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <center style="color: red; font-size: 15px; font-weight: bold;">Do you want to delete
                                this category?</center>
                            <input type="hidden" class="in_sub_cate_id" v-model="in_sub_cate_id" />
                        </div>
    ...
    methods: {
        defaultLoadingData() {
            this.datatable = $('#datatable').DataTable({
                ...
                'searching': false,
                'ajax': {
                    'url': `/api/category/getInSubCategoryData`,
                    'data': function (data) {
        ...
        deleteRow() {
            let id = $(".in_sub_cate_id").val();
            axios.post(`/api/category/removeInSubCategory?id=${id}`).then((res) => {
                $('.btn-close').click();
                this.datatable.draw();
                Swal.fire({
                    position: 'top-end',
        ...
        addNew() {
            this.$router.push('/category/add-new-in-sub-category');
        }
    }
};
</script>
