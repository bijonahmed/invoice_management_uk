    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
            <div class="alert-primary" role="alert">
                <div class="row">
                    <div class="col-md-10">Supplier Due Amount</div>
                    <input type="hidden" class="due_id" v-model="due_id" />
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="input-group mb-8">
                        <select name="due_id" class="form-select sulipper_id">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="text" class="due_id" v-model="due_id" />
                        </div>
    ...
    methods: {
        defaultLoadingData() {
            this.datatable = $('#datatable').DataTable({
                ...
                'searching': false,
                'ajax': {
                    'url': `/api/category/getDueAmountlist`,
                    'data': function (data) {
        ...
        addNew() {
            this.$router.push('/supplier/add-new-due-amount');
        }
