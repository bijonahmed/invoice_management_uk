    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
            <div class="alert-primary" role="alert">
                <div class="row">
                    <div class="col-md-10">Edit Supplier</div>
                    <div class="col-md-2">
                            ...
                            <form @submit.prevent="saveData()" id="formrest" class="forms-sample" enctype="multipart/form-data">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="hidden" class="form-control sulipper_id" v-model="cdata.sulipper_id" id="sulipper_id">
                                    </div>
                                </div>
...
export default {
    ...
    methods: {
        ...
        findRowId() {
            this.axios
                .get(`/api/category/editSupplierId/${this.$route.params.id}`)
                .then((response) => {
                    this.cdata.sulipper_id = response.data.data.sulipper_id;
                    this.cdata.name = response.data.data.name;
                    this.cdata.service = response.data.data.service;
