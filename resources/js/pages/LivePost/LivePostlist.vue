    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
            <div class="alert-primary" role="alert">
                <div class="row">
                    <div class="col-md-10">Live Streming List</div>
                    <div class="col-md-2"><a href="javascript:void(0)" @click="checkApi"><span stye="text-align:center;">Get API LINK</span></a></div>
                </div>
            </div><br>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="input-group mb-3">
                        <select class="form-select userid" id="userid">
                            <option value="">---All Models---</option>
                            <option v-for='data in ulist' :value='data.id'>{{data.name}}</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-3">
...
export default {
    ...
    methods: {
        ...
        addNew() {
            this.$router.push('/post/live-add-new-post');
        },
