        ...
        <div class="page-wrapper">
            ...
            <div class="page-content">
                <div class="alert-primary" role="alert">
                    <div class="row">
                        <div class="col-md-10">Item List</div>
                        <div class="col-md-2"><a href="javascript:void(0)" @click="addNew"><span
                                    stye="text-align:center;">Add
                                    New</span></a></div>
                    </div>
                </div><br>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control item_name" placeholder=" Name">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="input-group mb-3">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="hidden" class="item_id" v-model="item_id" />
                            </div>
...
export default {
    ...
    methods: {
        ...
        deleteRow() {
            let id = $(".item_id").val();
            axios.post(`/api/item/removeItem?id=${id}`).then((res) => {
                $('.btn-close').click();
                this.datatable.draw();
                Swal.fire({
                    position: 'top-end',
        ...
        addNew() {
            this.$router.push('/item/add-new-item');
        }
    }
};
</script>
